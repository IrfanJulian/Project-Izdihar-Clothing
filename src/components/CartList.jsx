    ...
    <div className='p-4 my-5 flex border-2 lg:w-max lg:mx-auto'>
        ...
        <div className="w-1/2 lg:w-max grid px-4">
            ...
            <div className="flex my-2 w-max lg:h-max lg:ml-5 lg:-mt-7">
                ...
                <p className='text-sm lg:text-xl font-bold mx-2 lg:mx-4 my-auto'>{qty}</p>
                <button className='w-4 h-4 my-auto lg:w-8 lg:h-8' onClick={click2}><img src={plus} alt="" /></button>
            </div>
